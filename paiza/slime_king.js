...
var _a = inputs[0].split(" ").map(Number), numberOfSlime = _a[0], firstLevel = _a[1];
var targetLevels = inputs[1].split(" ").map(Number);
...
targetLevels.sort(function (a, b) { return b - a; });
// targetLevels.forEach(targetlevel =>{
//     console.log(targetlevel);
// });
var tmpLevel = firstLevel;
var count = 0;
var maxLevel = targetLevels[0];
var i = 0;
var noChangeCount = 0;
while (1) {
